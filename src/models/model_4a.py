...
def sec_derivatives(u, g):
    ...
    for i in range(10):
        ...
        f3 = (2*u1*(u2+1))/((u2+1)**2+u1**2)-(2*u1*(u2+1)*(sqrt((u2+1)**2+u1**2)-1))/((u2+1)**2+u1**2)**(3/2)
    ...
    for i in range(9):
        ...
        f2 = (2*(u1+1)*(u2+1))/((u2+1)**2+(u1+1)**2)\
            -(2*(u1+1)*(u2+1)*(sqrt((u2+1)**2+(u1+1)**2)-sqrt(2)))/((u2+1)**2+(u1+1)**2)**(3/2)
        update_matrix_value(matrix, (2*j+1)-1, 1, f2)
        ...
        (2*(sqrt((u2+1)**2+(u1+1)**2)-sqrt(2)))/sqrt((u2+1)**2+(u1+1)**2)\
    ...
    for i in range(9):
        ...
        f2 = (2*(1-u1)*(u2+1)*(sqrt((u2+1)**2+(1-u1)**2)-sqrt(2)))/((u2+1)**2+(1-u1)**2)**(3/2)\
            -(2*(1-u1)*(u2+1))/((u2+1)**2+(1-u1)**2)
        update_matrix_value(matrix, (2*j-1)-1, 1, f2)

        # "p3: Sec-Derivative u2, u1:"
        f3 = (2*(1-u1)*(u2+1)*(sqrt((u2+1)**2+(1-u1)**2)-sqrt(2)))/((u2+1)**2+(1-u1)**2)**(3/2)\
            -(2*(1-u1)*(u2+1))/((u2+1)**2+(1-u1)**2)
        update_matrix_value(matrix, (2*j)-1, 0, f3)
    ...
    for i in range(30):
        ...
        f1 = (2*(sqrt((u3-u4)**2+(-u2+u1+1)**2)-1))/sqrt((u3-u4)**2+(-u2+u1+1)**2)\
            ...
            -(2*(-u2+u1+1)**2*(sqrt((u3-u4)**2+(-u2+u1+1)**2)-1))/((u3-u4)**2+(-u2+u1+1)**2)**(3/2)
        ...
        f3 = (2*(-u2+u1+1)*(u3-u4))/((u3-u4)**2+(-u2+u1+1)**2)\
            -(2*(-u2+u1+1)*(sqrt((u3-u4)**2+(-u2+u1+1)**2)-1)*(u3-u4))/((u3-u4)**2+(-u2+u1+1)**2)**(3/2)
        update_matrix_value(matrix, (2*j+19)-1, 2, f3)

        # "p4: Sec-Derivative u1, u4:"
        f4 = (2*(-u2+u1+1)*(sqrt((u3-u4)**2+(-u2+u1+1)**2)-1)*(u3-u4))/((u3-u4)**2+(-u2+u1+1)**2)**(3/2)\
        ...
        f7 = (2*(-u2+u1+1)*(sqrt((u3-u4)**2+(-u2+u1+1)**2)-1)*(u3-u4))/((u3-u4)**2+(-u2+u1+1)**2)**(3/2)\
             -(2*(-u2+u1+1)*(u3-u4))/((u3-u4)**2+(-u2+u1+1)**2)
        ...
        f10 = (2*(-u2+u1+1)*(sqrt((u3-u4)**2+(-u2+u1+1)**2)-1)*(u3-u4))/((u3-u4)**2+(-u2+u1+1)**2)**(3/2)\
              -(2*(-u2+u1+1)*(u3-u4))/((u3-u4)**2+(-u2+u1+1)**2)
        update_matrix_value(matrix, (2*j)-1, 1, f10)

        # "p4: Sec-Derivative u3, u3:"
        f11 = (2*(u3-u4)**2)/((u3-u4)**2+(-u2+u1+1)**2)\
              -(2*(sqrt((u3-u4)**2+(-u2+u1+1)**2)-1)*(u3-u4)**2)/((u3-u4)**2+(-u2+u1+1)**2)**(3/2)\
        ...
        f13 = (2*(-u2+u1+1)*(sqrt((u3-u4)**2+(-u2+u1+1)**2)-1)*(u3-u4))/((u3-u4)**2+(-u2+u1+1)**2)**(3/2)\
            -(2*(-u2+u1+1)*(u3-u4))/((u3-u4)**2+(-u2+u1+1)**2)
    ...
    for i in range(27):
        ...
        (2*(sqrt((-u4+u3+1)**2+(-u2+u1+1)**2)-sqrt(2)))/sqrt((-u4+u3+1)**2+(-u2+u1+1)**2)\
            +(2*(-u2+u1+1)**2)/((-u4+u3+1)**2+(-u2+u1+1)**2)\
            -(2*(-u2+u1+1)**2*(sqrt((-u4+u3+1)**2+(-u2+u1+1)**2)-sqrt(2)))/((-u4+u3+1)**2+(-u2+u1+1)**2)**(3/2)
